...
/***/ "./resources/js/controller/headers/create.js":
/*!***************************************************!*\
  !*** ./resources/js/controller/headers/create.js ***!
  \***************************************************/
/*! no exports provided */
...
var CtrIndex = new Vue({
  ...
  methods: {
    getColTypes: function () {
      var _getColTypes = _asyncToGenerator(
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(mode, header_id) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this.loading = true;
                requestPath = '/api/headers/getColTypes/' + mode + '/';
      ...
      function getColTypes(_x, _x2) {
        return _getColTypes.apply(this, arguments);
      }
    ...
    submit: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(mode, project_id) {
        var header_id,
            count,
            items,
            i,
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                header_id = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : null;
              ...
              case 4:
                this.loading = true;
                count = $('#item-list span').children().length;
                items = [];
                ...
                requestPath = '/api/headers/submit';
                _context2.next = 12;
              ...
              case 12:
                ...
                if (result.success) {
                  this.show = true; // window.location.href = '/'+project_id+'/headers/list';
...
/***/ 6:
/*!*********************************************************!*\
  !*** multi ./resources/js/controller/headers/create.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/imaishohei/tms/resources/js/controller/headers/create.js */"./resources/js/controller/headers/create.js");
